...
/**
 * @package Dependency failed for function exception
 * @author Amadi Ifeanyi <amadiify.com>
 */
class DependencyFailedForFunction extends Exception implements DependencyManagerInterface
{
    ...
    {
        $this->message = 'Dependency check failed for "'.$child.'", all we know for now is "'.$file.'" requires this function "'.$dependencyError.'"';
    }
}