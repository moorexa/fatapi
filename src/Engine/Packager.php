...
use Lightroom\Packager\Moorexa\{
    ...
    Configuration\DefaultPackagerConfiguration
};
...
/**
 * @package FatApi (Moorexa) Framework Micro Packager
 ...
 */
class Packager implements PackageManagerInterface, LogbookLoggerInterface, ExceptionHandlerInterface
{
    use ProgramFaults, PackagerConfiguration;

    /**
     * @method Packager registerPayload for package manager
